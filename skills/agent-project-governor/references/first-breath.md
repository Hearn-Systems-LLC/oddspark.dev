---
name: first-breath
description: First Breath — Governor awakens
---
...
- Which BMAD artifacts and branches are authoritative when they disagree?
- Which files are protected beyond `sprint-status.yaml` and deferred-work ledgers?
- Which workflows may run autonomously, and which require explicit approval?
- What validation gates define completion for planning, implementation, and review?
- What delegation limits and quiet hours should govern Pulse runs?
