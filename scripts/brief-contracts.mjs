...
export function deriveCandidateRef(candidateSchemaVersion, candidate) {
  ...
  return createHash("sha256").update(`oddspark-candidate-ref/v1\n${canonicalJson({ candidate_schema_version: candidateSchemaVersion, candidate })}`, "utf8").digest("hex");
}
...
export function deriveEvidenceRef(evidence) {
  ...
  return createHash("sha256").update(`oddspark-evidence-ref/v1\n${canonicalJson(evidence)}`, "utf8").digest("hex");
}
