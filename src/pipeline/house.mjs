// Canonical house-Brief catalog validation, identity, selection, and approval.
// Runtime-neutral: the Node fs loaders and CLI stay in scripts/house-briefs.mjs.

import { canonicalJson, deepFreeze, domainSeparatedHash, personalNamePolicy, validateBrief } from "./contracts.mjs";
import { validatePriors } from "./priors.mjs";
...
export function domainHash(domain, value) {
  return domainSeparatedHash("oddspark.house-briefs.v1", domain, value);
}
